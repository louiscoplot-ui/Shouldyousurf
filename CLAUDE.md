...
- Tests vitest : `tests/scoring.test.mjs` (107 cas, dont 11 cas terrain) — invariants verdict/ceilings/grille/NaN + continuité + dominante + sécurité ; `tests/wind-sample.test.mjs` (39 cas) — géométrie du point vent, sélection de la cellule la plus proche qui sort vraiment de la terre, garde-fous du recollage mer/spot
