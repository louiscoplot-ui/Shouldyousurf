  ...
  return (
    <html lang="en">
      <head>
        ...
        <style>{`
          html, body { background: #eef4f8; margin: 0; font-family: 'Inter', system-ui, sans-serif; color: #0f1e2e; }
          .load-wrap { position: fixed; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 20px; padding: 0 24px; text-align: center; background: linear-gradient(180deg, #eef4f8 0%, #dde7ee 100%); z-index: 1; }
