    ...
    <html lang="en">
      <head>
        ...
        {/* PostHog — product analytics. Loaded only if the env var is
            set. Defaults to US region (faster from Australia + most
            globally-distributed users); set NEXT_PUBLIC_POSTHOG_HOST
            to https://eu.i.posthog.com if you ever need EU residency. */}
        ...
        {/* Microsoft Clarity — heatmaps + session recordings, free &
            unlimited. Only loads if the env var is set. */}
