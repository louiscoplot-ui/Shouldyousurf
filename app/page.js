    ...
    <div className="page">
      ...
      <style jsx global>{`
        ...
        *, *::before, *::after { box-sizing: border-box; -webkit-tap-highlight-color: transparent; margin: 0; padding: 0; }
        ...
        .verdict-score { background: none; border: none; font-size: 11px; color: var(--text-mu); padding-top: 6px; cursor: pointer; display: flex; align-items: center; gap: 6px; }
        .verdict-score strong { color: var(--text); font-weight: 500; }
